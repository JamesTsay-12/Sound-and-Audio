...
#import aubio  # Removed aubio, replaced with librosa
...
import librosa  # Added librosa for pitch detection
...
# aubio pitch object removed, replaced by librosa in process_audio
...
class AudioAnalyzer(QtWidgets.QMainWindow):
    ...
    def process_audio(self, samples):
        ...
        # librosa.pyin returns pitch (f0) per frame, voiced flag, probabilities
        try:
            ...
            # In case of error, just skip pitch update
